...
mixin _$Animal {
 ...
 int get id; String get organizationId; String get url; String get type; String get species; String get age; String get gender; String get size; String get name; List<Photo> get photos; String get status; DateTime get publishedAt; String? get coat; String? get description;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Animal&&(identical(other.id, id) || other.id == id)&&(identical(other.organizationId, organizationId) || other.organizationId == organizationId)&&(identical(other.url, url) || other.url == url)&&(identical(other.type, type) || other.type == type)&&(identical(other.species, species) || other.species == species)&&(identical(other.age, age) || other.age == age)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.size, size) || other.size == size)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.photos, photos)&&(identical(other.status, status) || other.status == status)&&(identical(other.publishedAt, publishedAt) || other.publishedAt == publishedAt)&&(identical(other.coat, coat) || other.coat == coat)&&(identical(other.description, description) || other.description == description));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,organizationId,url,type,species,age,gender,size,name,const DeepCollectionEquality().hash(photos),status,publishedAt,coat,description);

@override
String toString() {
  return 'Animal(id: $id, organizationId: $organizationId, url: $url, type: $type, species: $species, age: $age, gender: $gender, size: $size, name: $name, photos: $photos, status: $status, publishedAt: $publishedAt, coat: $coat, description: $description)';
}
...
@useResult
$Res call({
 int id, String organizationId, String url, String type, String species, String age, String gender, String size, String name, List<Photo> photos, String status, DateTime publishedAt, String? coat, String? description
});
...
as DateTime,coat: freezed == coat ? _self.coat : coat // ignore: cast_nullable_to_non_nullable
...
class _Animal implements Animal {
  const _Animal({required this.id, required this.organizationId, required this.url, required this.type, required this.species, required this.age, required this.gender, required this.size, required this.name, required final  List<Photo> photos, required this.status, required this.publishedAt, this.coat, this.description}): _photos = photos;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Animal&&(identical(other.id, id) || other.id == id)&&(identical(other.organizationId, organizationId) || other.organizationId == organizationId)&&(identical(other.url, url) || other.url == url)&&(identical(other.type, type) || other.type == type)&&(identical(other.species, species) || other.species == species)&&(identical(other.age, age) || other.age == age)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.size, size) || other.size == size)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._photos, _photos)&&(identical(other.status, status) || other.status == status)&&(identical(other.publishedAt, publishedAt) || other.publishedAt == publishedAt)&&(identical(other.coat, coat) || other.coat == coat)&&(identical(other.description, description) || other.description == description));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,organizationId,url,type,species,age,gender,size,name,const DeepCollectionEquality().hash(_photos),status,publishedAt,coat,description);

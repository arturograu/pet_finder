...
mixin _$TokenResponse {
 ...
 String get tokenType; int get expiresIn; String get accessToken;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TokenResponse&&(identical(other.tokenType, tokenType) || other.tokenType == tokenType)&&(identical(other.expiresIn, expiresIn) || other.expiresIn == expiresIn)&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,tokenType,expiresIn,accessToken);

@override
String toString() {
  return 'TokenResponse(tokenType: $tokenType, expiresIn: $expiresIn, accessToken: $accessToken)';
}
...
@useResult
$Res call({
 String tokenType, int expiresIn, String accessToken
});
...
/// Create a copy of TokenResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? tokenType = null,Object? expiresIn = null,Object? accessToken = null,}) {
...
class _TokenResponse implements TokenResponse {
  const _TokenResponse({required this.tokenType, required this.expiresIn, required this.accessToken});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TokenResponse&&(identical(other.tokenType, tokenType) || other.tokenType == tokenType)&&(identical(other.expiresIn, expiresIn) || other.expiresIn == expiresIn)&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken));
}
...
/// Create a copy of TokenResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? tokenType = null,Object? expiresIn = null,Object? accessToken = null,}) {
